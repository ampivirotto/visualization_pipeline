...
ref='/home/tuk32868/res/human_g1k_v37.fasta'
...
for f in *txt                           ## loop through all txt files 
    filename=${f##*/}                   ## Use the last part of a path.
...
do
	mono /home/tuk32868/bin/autoconvert/AutoConvert.exe $direct/$f $direct/$f $direct/$bpm $direct/$egt  ## run autoconvert software
done
